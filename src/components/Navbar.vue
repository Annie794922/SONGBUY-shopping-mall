<template>
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            <router-link to="/" class="navbar-brand d-none d-lg-inline-block">SONG BUY</router-link>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav text-center text-lg-start">
                    <li class="nav-item d-inline-block d-lg-none">
                        <router-link to="/" class="link" :class=" this.$store.state.clickedNavButton === 1 ? 'clicked-button' : '' " aria-current="page" @click="closeNavbarList()">首頁</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link to="/contact" class="link" :class=" this.$store.state.clickedNavButton === 2 ? 'clicked-button' : '' " aria-current="page" @click="closeNavbarList()">聯絡我們</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link to="/products" class="link" :class=" this.$store.state.clickedNavButton === 3 ? 'clicked-button' : '' " @click="closeNavbarList()">商品目錄</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link to="/cart" class="link" :class=" this.$store.state.clickedNavButton === 4 ? 'clicked-button' : '' " @click="closeNavbarList()">購物車</router-link>
                    </li>
                    <li class="nav-item d-inline-block d-lg-none">
